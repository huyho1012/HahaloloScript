...
public class sidebarRightUI {
    ...
    public static final String VI_LANGUAGE_BUTTON = "//div[@class ='widget js-widget-lang-curr']//div[@class ='nav nav-pointer pl-2']/span[contains(text(),'Tiếng Việt')]";
    public static final String ENG_LANGUAGE_BUTTON = "//div[@class ='widget js-widget-lang-curr']//div[@class ='nav nav-pointer pl-2']/span[contains(text(),'English')]";
