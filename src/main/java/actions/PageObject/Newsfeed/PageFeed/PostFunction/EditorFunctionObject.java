...
import interfaces.Newsfeed.Editor.CommonEditorUI;
...
//    }
    ...
    public boolean checkConfirmCancelEditorPopUpDisplay(WebDriver driver) {
        waitElementToVisible(driver, CommonEditorUI.CONFIRM_CANCEL_CHANGE_POPUP);
        return checkIsDisplayedElement(driver, CommonEditorUI.CONFIRM_CANCEL_CHANGE_POPUP);
    }
